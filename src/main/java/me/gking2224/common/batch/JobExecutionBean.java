...
public class JobExecutionBean implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -1685461074005843847L;
    ...
    public String toString() {
        return String.format(
                "JobExecutionBean [jobParameters=%s, jobName=%s, status=%s, startTime=%s, createTime=%s, endTime=%s, lastUpdated=%s, exitStatus=%s, jobConfigurationName=%s, jobId=%s]",
                jobParameters, jobName, status, startTime, createTime, endTime, lastUpdated, exitStatus,
                jobConfigurationName, jobId);
    }
}